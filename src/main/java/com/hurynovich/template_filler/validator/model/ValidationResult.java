...
import static com.hurynovich.template_filler.validator.model.ValidationResultType.FAILURE;
import static com.hurynovich.template_filler.validator.model.ValidationResultType.SUCCESS;
...
public record ValidationResult(ValidationResultType type, List<String> errors) {
    ...
    public String formatErrors() {
        return join(ERRORS_DELIMITER, errors);
    }
}
